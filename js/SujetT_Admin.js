    ...
    var source ={
        datatype: "json",
        datafields: [{ name: 'code_tr' },{ name: 'titre' },{ name: 'abv' },{ name: 'eleve' },{ name: 'note' }],
        url: './index.php?controller=admin&action=gridSujetT'
    ...
    $("#jqxgrid").jqxGrid({
        ...
        columns: [{ text: 'Num.', align: 'center', datafield: 'code_tr', width: 70,renderer:columnsrenderer, cellsrenderer: cellsrenderer },
                { text: 'Sujet', datafield: 'titre', width: 270 ,renderer:columnsrenderer, cellsrenderer: cellsrenderer },
                { text: 'Ens.', datafield: 'abv', width: 100 ,renderer:columnsrenderer, cellsrenderer: cellsrenderer },
                { text: 'Elèves', datafield: 'eleve', width: 270 ,renderer:columnsrenderer, cellsrenderer: cellsrenderer },
                { text: 'Note', datafield: 'note', width: 70 ,renderer:columnsrenderer, cellsrenderer: cellsrenderer }]
    });
