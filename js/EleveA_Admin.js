$(document).ready(function () {
    ...
    var source = {
        datatype: "json",
        datafields: [{name: 'code_tr'},{name: 'eleve'}, {name: 'cycle'}, {name: 'annee'}, {name: 'groupe'}],
        url: './index.php?controller=admin&action=gridEleveA'
    ...
    $("#jqxgrid").jqxGrid({
        ...
        columns: [
            {text: '', align: 'center', datafield: 'code_tr',hidden:true},
