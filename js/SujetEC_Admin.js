    ...
    var source ={
        datatype: "json",
        datafields: [{ name: 'code_tr' },{ name: 'titre' },{ name: 'eleve' },{ name: 'etape_courante' }],
        url: './index.php?controller=admin&action=gridSujetEC'
    ...
    $("#jqxgrid").jqxGrid({
        ...
        columns: [{ text: 'Num.', align: 'center', datafield: 'code_tr', width: 70,renderer:columnsrenderer, cellsrenderer: cellsrenderer },
                ...
                { text: 'Etape<br/>Courante', datafield: 'etape_courante', width: 100 ,renderer:columnsrenderer, cellsrenderer: cellsrenderer }]
    });
