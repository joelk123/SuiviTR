...
class EditersujetForm extends \F3il\Form {
    ...
    public function render() {
        ...
        <form action="<?php echo $this->_destination; ?>" method="post">
            <div class="form-group">
                <label>Titre :</label>
                <input class="form-control" name="titre" value="<?php echo htmlspecialchars($this->titre); ?>"><br/>
                <label>Sujet :</label>
        ...
        <script>
            ...
            CKEDITOR.instances['sujet'].setData('<?php echo $this->sujet; ?>');
